    ...
    public partial class inicialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_FINANCIAL_SYSTEM", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_CATEGORY_TB_FINANCIAL_SYSTEM_IdSistema",
                        column: x => x.IdSistema,
                        principalTable: "TB_FINANCIAL_SYSTEM",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "TB_USER_FINANCIAL_SYSTEM",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_USER_FINANCIAL_SYSTEM", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TB_USER_FINANCIAL_SYSTEM_TB_FINANCIAL_SYSTEM_IdSistema",
                        column: x => x.IdSistema,
                        principalTable: "TB_FINANCIAL_SYSTEM",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_EXPENSE", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TB_EXPENSE_TB_CATEGORY_IdCategoria",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_CATEGORY_IdSistema",
                table: "TB_CATEGORY",
                column: "IdSistema");

            migrationBuilder.CreateIndex(
                name: "IX_TB_EXPENSE_IdCategoria",
                table: "TB_EXPENSE",
                column: "IdCategoria");

            migrationBuilder.CreateIndex(
                name: "IX_TB_USER_FINANCIAL_SYSTEM_IdSistema",
